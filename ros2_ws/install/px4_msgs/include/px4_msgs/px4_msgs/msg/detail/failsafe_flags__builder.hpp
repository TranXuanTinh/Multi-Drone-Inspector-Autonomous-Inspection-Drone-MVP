...
class Init_FailsafeFlags_traffic_avoidance_unhealthy
{
public:
  explicit Init_FailsafeFlags_traffic_avoidance_unhealthy(::px4_msgs::msg::FailsafeFlags & msg)
  : msg_(msg)
  {}
  Init_FailsafeFlags_remote_id_unhealthy traffic_avoidance_unhealthy(::px4_msgs::msg::FailsafeFlags::_traffic_avoidance_unhealthy_type arg)
  {
    msg_.traffic_avoidance_unhealthy = std::move(arg);
...
public:
  ...
  : msg_(msg)
  {}
  Init_FailsafeFlags_traffic_avoidance_unhealthy parachute_unhealthy(::px4_msgs::msg::FailsafeFlags::_parachute_unhealthy_type arg)
  {
    msg_.parachute_unhealthy = std::move(arg);
    return Init_FailsafeFlags_traffic_avoidance_unhealthy(msg_);
  }
