  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0xae, 0x59, 0xbb, 0x9e, 0xf2, 0xce, 0x74, 0xbb,
      0x34, 0x61, 0xf4, 0x3a, 0x1b, 0x7a, 0x5a, 0x5d,
      0x51, 0xc4, 0x3e, 0x49, 0x05, 0x76, 0x4a, 0x03,
      0xb3, 0x99, 0x89, 0xb3, 0xa8, 0x51, 0x20, 0x3d,
    }};
  return &hash;
}
...
static char px4_msgs__msg__InternalCombustionEngineStatus__FIELD_NAME__substate[] = "substate";
...
static char px4_msgs__msg__InternalCombustionEngineStatus__FIELD_NAME__pid_idle_rpm_integral[] = "pid_idle_rpm_integral";
...
static rosidl_runtime_c__type_description__Field px4_msgs__msg__InternalCombustionEngineStatus__FIELDS[] = {
  ...
  {
    {px4_msgs__msg__InternalCombustionEngineStatus__FIELD_NAME__substate, 8, 8},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_UINT8,
      0,
      0,
  ...
  {
    {px4_msgs__msg__InternalCombustionEngineStatus__FIELD_NAME__pid_idle_rpm_integral, 21, 21},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_FLOAT,
      0,
      0,
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {px4_msgs__msg__InternalCombustionEngineStatus__FIELDS, 25, 25},
    },
    {NULL, 0, 0},
  };
  if (!constructed) {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeSource source = {
    {px4_msgs__msg__InternalCombustionEngineStatus__TYPE_NAME, 43, 43},
    {msg_encoding, 3, 3},
    {toplevel_type_raw_source, 4221, 4221},
  };
  return &source;
}
