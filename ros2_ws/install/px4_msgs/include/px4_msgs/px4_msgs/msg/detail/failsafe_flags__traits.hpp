  ...
  std::ostream & out)
{
  ...
  // member: traffic_avoidance_unhealthy
  {
    out << "traffic_avoidance_unhealthy: ";
    rosidl_generator_traits::value_to_yaml(msg.traffic_avoidance_unhealthy, out);
    out << ", ";
  }
  ...
  {
    out << "gnss_lost: ";
    rosidl_generator_traits::value_to_yaml(msg.gnss_lost, out);
  }
  out << "}";
