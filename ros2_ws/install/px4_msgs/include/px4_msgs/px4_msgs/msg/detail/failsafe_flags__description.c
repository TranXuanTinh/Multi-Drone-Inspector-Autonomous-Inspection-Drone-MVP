  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0xed, 0x7b, 0xf8, 0xa9, 0xd6, 0x09, 0x59, 0x6b,
      0x05, 0x30, 0x3b, 0xff, 0x0c, 0x57, 0xee, 0x0c,
      0x4c, 0xcb, 0x69, 0x29, 0xc8, 0xf0, 0x0b, 0x66,
      0xd1, 0xfe, 0x43, 0x98, 0x03, 0x7b, 0xd1, 0x10,
    }};
  return &hash;
}
...
static char px4_msgs__msg__FailsafeFlags__FIELD_NAME__traffic_avoidance_unhealthy[] = "traffic_avoidance_unhealthy";
static char px4_msgs__msg__FailsafeFlags__FIELD_NAME__remote_id_unhealthy[] = "remote_id_unhealthy";
static char px4_msgs__msg__FailsafeFlags__FIELD_NAME__gnss_lost[] = "gnss_lost";
...
static rosidl_runtime_c__type_description__Field px4_msgs__msg__FailsafeFlags__FIELDS[] = {
  ...
  {
    {px4_msgs__msg__FailsafeFlags__FIELD_NAME__traffic_avoidance_unhealthy, 27, 27},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_BOOLEAN,
      0,
      0,
  ...
  {
    {px4_msgs__msg__FailsafeFlags__FIELD_NAME__gnss_lost, 9, 9},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_BOOLEAN,
      0,
      0,
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {px4_msgs__msg__FailsafeFlags__FIELDS, 47, 47},
    },
    {NULL, 0, 0},
  };
  if (!constructed) {
