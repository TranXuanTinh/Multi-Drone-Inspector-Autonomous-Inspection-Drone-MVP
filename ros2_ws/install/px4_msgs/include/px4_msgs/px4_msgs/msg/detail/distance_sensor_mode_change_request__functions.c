...
px4_msgs__msg__DistanceSensorModeChangeRequest__create(void)
{
...
px4_msgs__msg__DistanceSensorModeChangeRequest__Sequence__init(px4_msgs__msg__DistanceSensorModeChangeRequest__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(px4_msgs__msg__DistanceSensorModeChangeRequest)) {
      return false;
    }
  ...
  px4_msgs__msg__DistanceSensorModeChangeRequest__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(px4_msgs__msg__DistanceSensorModeChangeRequest)) {
      return false;
    }
