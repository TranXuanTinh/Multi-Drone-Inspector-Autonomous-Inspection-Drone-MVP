...
struct InternalCombustionEngineStatus_
{
  ...
  explicit InternalCombustionEngineStatus_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
      ...
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
      ...
      this->pid_idle_rpm_integral = 0.0f;
    }
  }
  ...
  using _pid_idle_rpm_integral_type =
    float;
  _pid_idle_rpm_integral_type pid_idle_rpm_integral;
  ...
  Type & set__pid_idle_rpm_integral(
    const float & _arg)
  {
    this->pid_idle_rpm_integral = _arg;
    return *this;
  }
  ...
  static constexpr uint8_t STATE_FAULT =
    3u;
  static constexpr uint8_t SUBSTATE_RUN =
    0u;
  static constexpr uint8_t SUBSTATE_IDLE =
    1u;
  static constexpr uint8_t SUBSTATE_REST =
    2u;
  ...
  bool operator==(const InternalCombustionEngineStatus_ & other) const
  {
    ...
    if (this->pid_idle_rpm_integral != other.pid_idle_rpm_integral) {
      return false;
    }
    return true;
  }
...
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint8_t InternalCombustionEngineStatus_<ContainerAllocator>::SUBSTATE_RUN;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint8_t InternalCombustionEngineStatus_<ContainerAllocator>::SUBSTATE_IDLE;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint8_t InternalCombustionEngineStatus_<ContainerAllocator>::SUBSTATE_REST;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
