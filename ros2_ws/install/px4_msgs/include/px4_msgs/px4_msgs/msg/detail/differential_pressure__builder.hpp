...
// IWYU pragma: private, include "px4_msgs/msg/differential_pressure.hpp"
...
class Init_DifferentialPressure_pitot_temperature
{
public:
  explicit Init_DifferentialPressure_pitot_temperature(::px4_msgs::msg::DifferentialPressure & msg)
  : msg_(msg)
  {}
  Init_DifferentialPressure_error_count pitot_temperature(::px4_msgs::msg::DifferentialPressure::_pitot_temperature_type arg)
  {
    msg_.pitot_temperature = std::move(arg);
...
public:
  ...
  : msg_(msg)
  {}
  Init_DifferentialPressure_pitot_temperature temperature(::px4_msgs::msg::DifferentialPressure::_temperature_type arg)
  {
    msg_.temperature = std::move(arg);
    return Init_DifferentialPressure_pitot_temperature(msg_);
  }
