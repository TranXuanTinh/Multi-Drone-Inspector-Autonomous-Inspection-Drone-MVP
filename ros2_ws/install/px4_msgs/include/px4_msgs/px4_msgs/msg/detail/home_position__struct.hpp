...
struct HomePosition_
{
  ...
  using _valid_attitude_type =
    bool;
  _valid_attitude_type valid_attitude;
  ...
  Type & set__valid_attitude(
    const bool & _arg)
  {
    this->valid_attitude = _arg;
    return *this;
  }
  ...
  bool operator==(const HomePosition_ & other) const
  {
    ...
    if (this->valid_attitude != other.valid_attitude) {
      return false;
    }
