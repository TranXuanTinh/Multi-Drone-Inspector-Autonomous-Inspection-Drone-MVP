...
struct FailsafeFlags_
{
  ...
  explicit FailsafeFlags_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
      ...
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
      ...
      this->traffic_avoidance_unhealthy = false;
      this->remote_id_unhealthy = false;
      this->gnss_lost = false;
    }
  }
  ...
  using _traffic_avoidance_unhealthy_type =
    bool;
  _traffic_avoidance_unhealthy_type traffic_avoidance_unhealthy;
  using _remote_id_unhealthy_type =
    bool;
  _remote_id_unhealthy_type remote_id_unhealthy;
  using _gnss_lost_type =
    bool;
  _gnss_lost_type gnss_lost;
  ...
  Type & set__traffic_avoidance_unhealthy(
    const bool & _arg)
  {
    this->traffic_avoidance_unhealthy = _arg;
    return *this;
  }
  ...
  bool operator==(const FailsafeFlags_ & other) const
  {
    ...
    if (this->traffic_avoidance_unhealthy != other.traffic_avoidance_unhealthy) {
      return false;
    }
    if (this->remote_id_unhealthy != other.remote_id_unhealthy) {
      return false;
    }
    if (this->gnss_lost != other.gnss_lost) {
      return false;
    }
    return true;
  }
