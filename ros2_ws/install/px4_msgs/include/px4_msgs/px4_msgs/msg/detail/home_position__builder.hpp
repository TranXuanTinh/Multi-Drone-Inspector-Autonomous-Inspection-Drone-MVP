...
class Init_HomePosition_valid_attitude
{
public:
  explicit Init_HomePosition_valid_attitude(::px4_msgs::msg::HomePosition & msg)
  : msg_(msg)
  {}
  Init_HomePosition_manual_home valid_attitude(::px4_msgs::msg::HomePosition::_valid_attitude_type arg)
  {
    msg_.valid_attitude = std::move(arg);
...
public:
  ...
  : msg_(msg)
  {}
  Init_HomePosition_valid_attitude valid_lpos(::px4_msgs::msg::HomePosition::_valid_lpos_type arg)
  {
    msg_.valid_lpos = std::move(arg);
    return Init_HomePosition_valid_attitude(msg_);
  }
