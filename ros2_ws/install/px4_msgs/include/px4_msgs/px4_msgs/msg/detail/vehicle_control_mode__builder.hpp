...
public:
  ...
  : msg_(msg)
  {}
  Init_VehicleControlMode_flag_control_attitude_enabled flag_control_climb_rate_enabled(::px4_msgs::msg::VehicleControlMode::_flag_control_climb_rate_enabled_type arg)
  {
