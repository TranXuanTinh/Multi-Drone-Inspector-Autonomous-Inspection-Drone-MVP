...
// IWYU pragma: private, include "px4_msgs/msg/camera_capture.hpp"
...
class Init_CameraCapture_report
{
public:
  explicit Init_CameraCapture_report(::px4_msgs::msg::CameraCapture & msg)
  : msg_(msg)
  {}
  ::px4_msgs::msg::CameraCapture report(::px4_msgs::msg::CameraCapture::_report_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_CameraCapture_report result(::px4_msgs::msg::CameraCapture::_result_type arg)
  {
    msg_.result = std::move(arg);
    return Init_CameraCapture_report(msg_);
  }
