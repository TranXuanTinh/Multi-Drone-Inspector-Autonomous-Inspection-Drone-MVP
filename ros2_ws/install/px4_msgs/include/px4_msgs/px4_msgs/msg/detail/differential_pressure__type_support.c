...
static rosidl_typesupport_introspection_c__MessageMember px4_msgs__msg__DifferentialPressure__rosidl_typesupport_introspection_c__DifferentialPressure_message_member_array[7] = {
  {
    "timestamp",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4_msgs__msg__DifferentialPressure, pitot_temperature),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
