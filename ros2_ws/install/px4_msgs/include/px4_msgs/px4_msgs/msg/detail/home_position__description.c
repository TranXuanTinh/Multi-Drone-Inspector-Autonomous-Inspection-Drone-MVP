  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0x6c, 0xef, 0x57, 0x1e, 0x87, 0x6b, 0x97, 0x9a,
      0xc4, 0x84, 0x96, 0x15, 0x14, 0xad, 0xf7, 0x01,
      0x47, 0x4e, 0x8d, 0x6e, 0xa6, 0x66, 0x40, 0x02,
      0x7b, 0x2d, 0x26, 0xa0, 0xd7, 0x0b, 0x47, 0x67,
    }};
  return &hash;
}
...
static char px4_msgs__msg__HomePosition__FIELD_NAME__valid_attitude[] = "valid_attitude";
...
static rosidl_runtime_c__type_description__Field px4_msgs__msg__HomePosition__FIELDS[] = {
  ...
  {
    {px4_msgs__msg__HomePosition__FIELD_NAME__valid_attitude, 14, 14},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_BOOLEAN,
      0,
      0,
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {px4_msgs__msg__HomePosition__FIELDS, 16, 16},
    },
    {NULL, 0, 0},
  };
  if (!constructed) {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeSource source = {
    {px4_msgs__msg__HomePosition__TYPE_NAME, 25, 25},
    {msg_encoding, 3, 3},
    {toplevel_type_raw_source, 879, 879},
  };
  return &source;
}
