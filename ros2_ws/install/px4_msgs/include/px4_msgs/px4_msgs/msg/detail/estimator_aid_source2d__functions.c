...
px4_msgs__msg__EstimatorAidSource2d__create(void)
{
...
px4_msgs__msg__EstimatorAidSource2d__Sequence__init(px4_msgs__msg__EstimatorAidSource2d__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(px4_msgs__msg__EstimatorAidSource2d)) {
      return false;
    }
  ...
  px4_msgs__msg__EstimatorAidSource2d__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(px4_msgs__msg__EstimatorAidSource2d)) {
      return false;
    }
