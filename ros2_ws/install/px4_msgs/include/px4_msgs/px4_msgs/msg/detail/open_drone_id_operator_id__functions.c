...
px4_msgs__msg__OpenDroneIdOperatorId__create(void)
{
...
px4_msgs__msg__OpenDroneIdOperatorId__Sequence__init(px4_msgs__msg__OpenDroneIdOperatorId__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(px4_msgs__msg__OpenDroneIdOperatorId)) {
      return false;
    }
  ...
  px4_msgs__msg__OpenDroneIdOperatorId__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(px4_msgs__msg__OpenDroneIdOperatorId)) {
      return false;
    }
