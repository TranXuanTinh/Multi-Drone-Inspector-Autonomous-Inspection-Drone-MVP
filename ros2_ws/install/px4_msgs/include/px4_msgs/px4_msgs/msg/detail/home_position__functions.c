...
px4_msgs__msg__HomePosition__are_equal(const px4_msgs__msg__HomePosition * lhs, const px4_msgs__msg__HomePosition * rhs)
{
  ...
  // valid_attitude
  if (lhs->valid_attitude != rhs->valid_attitude) {
    return false;
  }
  // manual_home
  ...
  px4_msgs__msg__HomePosition * output)
{
  ...
  // valid_attitude
  output->valid_attitude = input->valid_attitude;
  // manual_home
...
px4_msgs__msg__HomePosition__create(void)
{
...
px4_msgs__msg__HomePosition__Sequence__init(px4_msgs__msg__HomePosition__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(px4_msgs__msg__HomePosition)) {
      return false;
    }
  ...
  px4_msgs__msg__HomePosition__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(px4_msgs__msg__HomePosition)) {
      return false;
    }
