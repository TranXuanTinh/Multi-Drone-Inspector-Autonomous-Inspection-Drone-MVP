...
px4_msgs__msg__DifferentialPressure__are_equal(const px4_msgs__msg__DifferentialPressure * lhs, const px4_msgs__msg__DifferentialPressure * rhs)
{
  ...
  // pitot_temperature
  if (lhs->pitot_temperature != rhs->pitot_temperature) {
    return false;
  }
  // error_count
  ...
  px4_msgs__msg__DifferentialPressure * output)
{
  ...
  // pitot_temperature
  output->pitot_temperature = input->pitot_temperature;
  // error_count
...
px4_msgs__msg__DifferentialPressure__create(void)
{
...
px4_msgs__msg__DifferentialPressure__Sequence__init(px4_msgs__msg__DifferentialPressure__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(px4_msgs__msg__DifferentialPressure)) {
      return false;
    }
  ...
  px4_msgs__msg__DifferentialPressure__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(px4_msgs__msg__DifferentialPressure)) {
      return false;
    }
