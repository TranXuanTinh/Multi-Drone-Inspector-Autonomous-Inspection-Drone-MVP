...
struct TransponderReport_
{
  ...
  static constexpr uint16_t PX4_ADSB_FLAGS_VALID_SQUAWK =
    32u;
  static constexpr uint16_t PX4_ADSB_FLAGS_SIMULATED =
    64u;
  static constexpr uint16_t PX4_ADSB_FLAGS_VERTICAL_VELOCITY_VALID =
    128u;
  static constexpr uint16_t PX4_ADSB_FLAGS_BARO_VALID =
    256u;
  static constexpr uint16_t PX4_ADSB_FLAGS_SOURCE_UAT =
    32768u;
...
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint16_t TransponderReport_<ContainerAllocator>::PX4_ADSB_FLAGS_SIMULATED;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint16_t TransponderReport_<ContainerAllocator>::PX4_ADSB_FLAGS_VERTICAL_VELOCITY_VALID;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint16_t TransponderReport_<ContainerAllocator>::PX4_ADSB_FLAGS_BARO_VALID;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint16_t TransponderReport_<ContainerAllocator>::PX4_ADSB_FLAGS_SOURCE_UAT;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
