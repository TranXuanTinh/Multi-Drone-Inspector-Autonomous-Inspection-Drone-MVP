...
static rosidl_typesupport_introspection_c__MessageMember px4_msgs__msg__CameraCapture__rosidl_typesupport_introspection_c__CameraCapture_message_member_array[10] = {
  {
    "timestamp",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(px4_msgs__msg__CameraCapture, report),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
