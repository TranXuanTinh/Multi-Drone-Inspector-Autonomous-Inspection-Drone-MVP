...
struct DifferentialPressure_
{
  ...
  using _pitot_temperature_type =
    float;
  _pitot_temperature_type pitot_temperature;
  ...
  Type & set__pitot_temperature(
    const float & _arg)
  {
    this->pitot_temperature = _arg;
    return *this;
  }
  ...
  bool operator==(const DifferentialPressure_ & other) const
  {
    ...
    if (this->pitot_temperature != other.pitot_temperature) {
      return false;
    }
