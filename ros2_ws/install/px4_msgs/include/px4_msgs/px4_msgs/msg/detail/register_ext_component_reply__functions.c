...
px4_msgs__msg__RegisterExtComponentReply__create(void)
{
...
px4_msgs__msg__RegisterExtComponentReply__Sequence__init(px4_msgs__msg__RegisterExtComponentReply__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(px4_msgs__msg__RegisterExtComponentReply)) {
      return false;
    }
  ...
  px4_msgs__msg__RegisterExtComponentReply__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(px4_msgs__msg__RegisterExtComponentReply)) {
      return false;
    }
