...
// IWYU pragma: private, include "px4_msgs/msg/internal_combustion_engine_status.hpp"
...
class Init_InternalCombustionEngineStatus_pid_idle_rpm_integral
{
public:
  explicit Init_InternalCombustionEngineStatus_pid_idle_rpm_integral(::px4_msgs::msg::InternalCombustionEngineStatus & msg)
  : msg_(msg)
  {}
  ::px4_msgs::msg::InternalCombustionEngineStatus pid_idle_rpm_integral(::px4_msgs::msg::InternalCombustionEngineStatus::_pid_idle_rpm_integral_type arg)
  {
    msg_.pid_idle_rpm_integral = std::move(arg);
...
public:
  ...
  : msg_(msg)
  {}
  Init_InternalCombustionEngineStatus_pid_idle_rpm_integral lambda_coefficient(::px4_msgs::msg::InternalCombustionEngineStatus::_lambda_coefficient_type arg)
  {
    msg_.lambda_coefficient = std::move(arg);
    return Init_InternalCombustionEngineStatus_pid_idle_rpm_integral(msg_);
  }
...
class Init_InternalCombustionEngineStatus_substate
{
public:
  explicit Init_InternalCombustionEngineStatus_substate(::px4_msgs::msg::InternalCombustionEngineStatus & msg)
  : msg_(msg)
  {}
  Init_InternalCombustionEngineStatus_flags substate(::px4_msgs::msg::InternalCombustionEngineStatus::_substate_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_InternalCombustionEngineStatus_substate state(::px4_msgs::msg::InternalCombustionEngineStatus::_state_type arg)
  {
    msg_.state = std::move(arg);
    return Init_InternalCombustionEngineStatus_substate(msg_);
  }
