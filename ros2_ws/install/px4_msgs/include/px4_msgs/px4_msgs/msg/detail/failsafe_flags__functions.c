...
px4_msgs__msg__FailsafeFlags__are_equal(const px4_msgs__msg__FailsafeFlags * lhs, const px4_msgs__msg__FailsafeFlags * rhs)
{
  ...
  // traffic_avoidance_unhealthy
  if (lhs->traffic_avoidance_unhealthy != rhs->traffic_avoidance_unhealthy) {
    return false;
  }
  // remote_id_unhealthy
  ...
  px4_msgs__msg__FailsafeFlags * output)
{
  ...
  // traffic_avoidance_unhealthy
  output->traffic_avoidance_unhealthy = input->traffic_avoidance_unhealthy;
  // remote_id_unhealthy
...
px4_msgs__msg__FailsafeFlags__Sequence__init(px4_msgs__msg__FailsafeFlags__Sequence * array, size_t size)
{
  ...
  if (size) {
    if (size > SIZE_MAX / sizeof(px4_msgs__msg__FailsafeFlags)) {
      return false;
    }
  ...
  px4_msgs__msg__FailsafeFlags__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    if (input->size > SIZE_MAX / sizeof(px4_msgs__msg__FailsafeFlags)) {
      return false;
    }
