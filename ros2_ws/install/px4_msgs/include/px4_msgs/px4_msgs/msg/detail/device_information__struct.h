...
/// Constant 'DEVICE_TYPE_TRAFFIC_AVOIDANCE'.
/**
  * Traffic Avoidance system (ADSB)
 */
enum
{
  px4_msgs__msg__DeviceInformation__DEVICE_TYPE_TRAFFIC_AVOIDANCE = 16
};

/// Constant 'DEVICE_TYPE_COMPUTE'.
/**
  * Compute boards
 */
enum
{
  px4_msgs__msg__DeviceInformation__DEVICE_TYPE_COMPUTE = 17
};

/// Constant 'DEVICE_TYPE_LIDAR'.
/**
  * 3D scanning / multi-beam Lidar
 */
enum
{
  px4_msgs__msg__DeviceInformation__DEVICE_TYPE_LIDAR = 18
};

/// Constant 'DEVICE_TYPE_STEREO_CAMERA'.
/**
  * stereo/depth camera
 */
enum
{
  px4_msgs__msg__DeviceInformation__DEVICE_TYPE_STEREO_CAMERA = 19
};
