...
struct DeviceInformation_
{
  ...
  static constexpr uint8_t DEVICE_TYPE_HYGROMETER =
    15u;
  static constexpr uint8_t DEVICE_TYPE_TRAFFIC_AVOIDANCE =
    16u;
  static constexpr uint8_t DEVICE_TYPE_COMPUTE =
    17u;
  static constexpr uint8_t DEVICE_TYPE_LIDAR =
    18u;
  static constexpr uint8_t DEVICE_TYPE_STEREO_CAMERA =
    19u;
...
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint8_t DeviceInformation_<ContainerAllocator>::DEVICE_TYPE_TRAFFIC_AVOIDANCE;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint8_t DeviceInformation_<ContainerAllocator>::DEVICE_TYPE_COMPUTE;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint8_t DeviceInformation_<ContainerAllocator>::DEVICE_TYPE_LIDAR;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint8_t DeviceInformation_<ContainerAllocator>::DEVICE_TYPE_STEREO_CAMERA;
#endif  // __cplusplus < 201703L
