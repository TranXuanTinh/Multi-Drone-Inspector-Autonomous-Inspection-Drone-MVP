...
class Metaclass_RtcmData(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'px4_msgs.msg.RtcmData')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__rtcm_data
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__rtcm_data
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__rtcm_data
            cls._TYPE_SUPPORT = module.type_support_msg__msg__rtcm_data
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__rtcm_data
    ...
    def ORB_QUEUE_LENGTH(self):
        ...
        return Metaclass_RtcmData.__constants['ORB_QUEUE_LENGTH']

    @property
    def MAX_INSTANCES(self):
        """Message constant 'MAX_INSTANCES'."""
        return Metaclass_RtcmData.__constants['MAX_INSTANCES']


class RtcmData(metaclass=Metaclass_RtcmData):
    """
    Message class 'RtcmData'.
