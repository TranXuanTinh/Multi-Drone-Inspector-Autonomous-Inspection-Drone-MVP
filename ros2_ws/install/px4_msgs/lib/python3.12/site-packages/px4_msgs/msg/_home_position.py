...
class HomePosition(metaclass=Metaclass_HomePosition):
    ...
    def __init__(self, **kwargs):
        ...
        self.valid_attitude = kwargs.get('valid_attitude', bool())
    ...
    def __eq__(self, other):
        ...
        if self.valid_lpos != other.valid_lpos:
            return False
        if self.valid_attitude != other.valid_attitude:
            return False
    ...
    @builtins.property
    def valid_attitude(self):
        """Message field 'valid_attitude'."""
        return self._valid_attitude

    @valid_attitude.setter
    def valid_attitude(self, value):
        if self._check_fields:
            assert \
                isinstance(value, bool), \
                "The 'valid_attitude' field must be of type 'bool'"
        self._valid_attitude = value
