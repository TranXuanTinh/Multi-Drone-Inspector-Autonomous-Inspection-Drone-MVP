...
class FailsafeFlags(metaclass=Metaclass_FailsafeFlags):
    ...
    _fields_and_field_types = {
        ...
        'traffic_avoidance_unhealthy': 'boolean',
    ...
    def __init__(self, **kwargs):
        ...
        self.traffic_avoidance_unhealthy = kwargs.get('traffic_avoidance_unhealthy', bool())
        self.remote_id_unhealthy = kwargs.get('remote_id_unhealthy', bool())
        self.gnss_lost = kwargs.get('gnss_lost', bool())
    ...
    def __eq__(self, other):
        ...
        if self.parachute_unhealthy != other.parachute_unhealthy:
            return False
        if self.traffic_avoidance_unhealthy != other.traffic_avoidance_unhealthy:
            return False
        if self.remote_id_unhealthy != other.remote_id_unhealthy:
            return False
        if self.gnss_lost != other.gnss_lost:
            return False
        return True
    ...
    @builtins.property
    def traffic_avoidance_unhealthy(self):
        """Message field 'traffic_avoidance_unhealthy'."""
        return self._traffic_avoidance_unhealthy

    @traffic_avoidance_unhealthy.setter
    def traffic_avoidance_unhealthy(self, value):
        if self._check_fields:
            assert \
                isinstance(value, bool), \
                "The 'traffic_avoidance_unhealthy' field must be of type 'bool'"
        self._traffic_avoidance_unhealthy = value
    ...
    @builtins.property
    def gnss_lost(self):
        """Message field 'gnss_lost'."""
        return self._gnss_lost

    @gnss_lost.setter
    def gnss_lost(self, value):
        if self._check_fields:
            assert \
                isinstance(value, bool), \
                "The 'gnss_lost' field must be of type 'bool'"
        self._gnss_lost = value
