...
class Metaclass_DeviceInformation(type):
    ...
    __constants = {
        ...
        'DEVICE_TYPE_TRAFFIC_AVOIDANCE': 16,
        'DEVICE_TYPE_COMPUTE': 17,
        'DEVICE_TYPE_LIDAR': 18,
        'DEVICE_TYPE_STEREO_CAMERA': 19,
    }
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            ...
            'DEVICE_TYPE_TRAFFIC_AVOIDANCE': cls.__constants['DEVICE_TYPE_TRAFFIC_AVOIDANCE'],
            'DEVICE_TYPE_COMPUTE': cls.__constants['DEVICE_TYPE_COMPUTE'],
            'DEVICE_TYPE_LIDAR': cls.__constants['DEVICE_TYPE_LIDAR'],
            'DEVICE_TYPE_STEREO_CAMERA': cls.__constants['DEVICE_TYPE_STEREO_CAMERA'],
        }
    ...
    @property
    def DEVICE_TYPE_TRAFFIC_AVOIDANCE(self):
        """Message constant 'DEVICE_TYPE_TRAFFIC_AVOIDANCE'."""
        return Metaclass_DeviceInformation.__constants['DEVICE_TYPE_TRAFFIC_AVOIDANCE']

    @property
    def DEVICE_TYPE_COMPUTE(self):
        """Message constant 'DEVICE_TYPE_COMPUTE'."""
        return Metaclass_DeviceInformation.__constants['DEVICE_TYPE_COMPUTE']

    @property
    def DEVICE_TYPE_LIDAR(self):
        """Message constant 'DEVICE_TYPE_LIDAR'."""
        return Metaclass_DeviceInformation.__constants['DEVICE_TYPE_LIDAR']

    @property
    def DEVICE_TYPE_STEREO_CAMERA(self):
        """Message constant 'DEVICE_TYPE_STEREO_CAMERA'."""
        return Metaclass_DeviceInformation.__constants['DEVICE_TYPE_STEREO_CAMERA']
...
class DeviceInformation(metaclass=Metaclass_DeviceInformation):
    ...
    Constants:
      ...
      DEVICE_TYPE_TRAFFIC_AVOIDANCE
      DEVICE_TYPE_COMPUTE
      DEVICE_TYPE_LIDAR
      DEVICE_TYPE_STEREO_CAMERA
    """
