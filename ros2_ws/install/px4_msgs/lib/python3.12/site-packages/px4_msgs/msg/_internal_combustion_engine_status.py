...
class Metaclass_InternalCombustionEngineStatus(type):
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            ...
            'SUBSTATE_RUN': cls.__constants['SUBSTATE_RUN'],
            'SUBSTATE_IDLE': cls.__constants['SUBSTATE_IDLE'],
            'SUBSTATE_REST': cls.__constants['SUBSTATE_REST'],
    ...
    @property
    def SUBSTATE_RUN(self):
        """Message constant 'SUBSTATE_RUN'."""
        return Metaclass_InternalCombustionEngineStatus.__constants['SUBSTATE_RUN']

    @property
    def SUBSTATE_IDLE(self):
        """Message constant 'SUBSTATE_IDLE'."""
        return Metaclass_InternalCombustionEngineStatus.__constants['SUBSTATE_IDLE']

    @property
    def SUBSTATE_REST(self):
        """Message constant 'SUBSTATE_REST'."""
        return Metaclass_InternalCombustionEngineStatus.__constants['SUBSTATE_REST']
...
class InternalCombustionEngineStatus(metaclass=Metaclass_InternalCombustionEngineStatus):
    ...
    def __init__(self, **kwargs):
        ...
        self.substate = kwargs.get('substate', int())
        ...
        self.pid_idle_rpm_integral = kwargs.get('pid_idle_rpm_integral', float())
    ...
    def __eq__(self, other):
        ...
        if self.lambda_coefficient != other.lambda_coefficient:
            return False
        if self.pid_idle_rpm_integral != other.pid_idle_rpm_integral:
            return False
        return True
    ...
    def substate(self, value):
        if self._check_fields:
            assert \
                isinstance(value, int), \
                "The 'substate' field must be of type 'int'"
            assert value >= 0 and value < 256, \
                "The 'substate' field must be an unsigned integer in [0, 255]"
    ...
    @builtins.property
    def pid_idle_rpm_integral(self):
        """Message field 'pid_idle_rpm_integral'."""
        return self._pid_idle_rpm_integral

    @pid_idle_rpm_integral.setter
    def pid_idle_rpm_integral(self, value):
        if self._check_fields:
            assert \
                isinstance(value, float), \
                "The 'pid_idle_rpm_integral' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'pid_idle_rpm_integral' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._pid_idle_rpm_integral = value
