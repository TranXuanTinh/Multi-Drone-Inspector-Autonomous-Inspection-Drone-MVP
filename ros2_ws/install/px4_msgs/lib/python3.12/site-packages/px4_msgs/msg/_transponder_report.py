...
class Metaclass_TransponderReport(type):
    ...
    __constants = {
        ...
        'PX4_ADSB_FLAGS_VERTICAL_VELOCITY_VALID': 128,
        'PX4_ADSB_FLAGS_BARO_VALID': 256,
        'PX4_ADSB_FLAGS_SOURCE_UAT': 32768,
        'ORB_QUEUE_LENGTH': 16,
    }
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            ...
            'PX4_ADSB_FLAGS_SIMULATED': cls.__constants['PX4_ADSB_FLAGS_SIMULATED'],
            'PX4_ADSB_FLAGS_VERTICAL_VELOCITY_VALID': cls.__constants['PX4_ADSB_FLAGS_VERTICAL_VELOCITY_VALID'],
            'PX4_ADSB_FLAGS_BARO_VALID': cls.__constants['PX4_ADSB_FLAGS_BARO_VALID'],
            'PX4_ADSB_FLAGS_SOURCE_UAT': cls.__constants['PX4_ADSB_FLAGS_SOURCE_UAT'],
    ...
    @property
    def PX4_ADSB_FLAGS_SIMULATED(self):
        """Message constant 'PX4_ADSB_FLAGS_SIMULATED'."""
        return Metaclass_TransponderReport.__constants['PX4_ADSB_FLAGS_SIMULATED']

    @property
    def PX4_ADSB_FLAGS_VERTICAL_VELOCITY_VALID(self):
        """Message constant 'PX4_ADSB_FLAGS_VERTICAL_VELOCITY_VALID'."""
        return Metaclass_TransponderReport.__constants['PX4_ADSB_FLAGS_VERTICAL_VELOCITY_VALID']

    @property
    def PX4_ADSB_FLAGS_BARO_VALID(self):
        """Message constant 'PX4_ADSB_FLAGS_BARO_VALID'."""
        return Metaclass_TransponderReport.__constants['PX4_ADSB_FLAGS_BARO_VALID']

    @property
    def PX4_ADSB_FLAGS_SOURCE_UAT(self):
        """Message constant 'PX4_ADSB_FLAGS_SOURCE_UAT'."""
        return Metaclass_TransponderReport.__constants['PX4_ADSB_FLAGS_SOURCE_UAT']
...
class TransponderReport(metaclass=Metaclass_TransponderReport):
    ...
    Constants:
      ...
      PX4_ADSB_FLAGS_SIMULATED
      PX4_ADSB_FLAGS_VERTICAL_VELOCITY_VALID
      PX4_ADSB_FLAGS_BARO_VALID
      PX4_ADSB_FLAGS_SOURCE_UAT
      ORB_QUEUE_LENGTH
    """
